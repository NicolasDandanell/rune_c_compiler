...
use crate::{
    RuneFileDescription,
    c_utilities::{CStructMember, pascal_to_snake_case, pascal_to_uppercase, spaces},
...
pub fn output_source(file: &RuneFileDescription, output_path: &Path) {
    ...
    for struct_definition in &file.definitions.structs {
        ...
        for i in 0..(member_count as usize) {
            ...
            let verification_string: String = match has_verification && i == member_count as usize - 1 {
                false => String::from(""),
